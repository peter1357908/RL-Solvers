# credit: sentdex of Youtube
# check out https://pythonprogramming.net/q-learning-analysis-reinforcement-learning-python-tutorial/
# this time, we figure out the constants that we took for granted
# comments from the basic solver removed
import numpy as np
import gym
...
ep_rewards = []
aggr_ep_rewards = {'ep': [], 'avg': [], 'min': [], 'max': []}  # aggregate episode rewards
