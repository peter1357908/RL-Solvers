...
if __name__ == "__main__":
    ...
    env = DummyVecEnv([lambda: gym.make('Self_Driving_Ball:BallGoalGravityStopEasy-v0')])  # agent trained on Easy can solve the regular version of the environment
